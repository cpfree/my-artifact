...
@Getter
@ToString
public class PixelPicGeneInfo {

    private PixelPicGeneConfig param;
    private PixelPngSource source;
    /**
     * 文件头
     */
    private PixelPicHeader header;
    /**
     * 图片宽度
     */
    ...
    public PixelPicGeneInfo(PixelPicGeneConfig param, PixelPngSource source) throws IOException {
        this.param = param;
        this.source = source;
        // check
        ...
        long pxTotalSize = 8 + mappingColor.length + (4 + 4 + headBytes.length + dataByte.length) * 8 / bitCnt;
        // 绘制区域宽度
